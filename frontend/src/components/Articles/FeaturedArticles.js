...
const FeaturedArticles = () => {
  ...
  return (
    <div className="flex flex-col p-3">
      ...
      <div className="flex justify-center text-gray-900 dark:text-white">
        <Link to='/makaleler/listele' className="hover:text-emerald-600 border-b border-transparent hover:border-emerald-600 pb-1 transition-colors duration-300 ease-in-out">Tüm Makaleler</Link>
      </div>
    </div>
  );
};
